...
export default function Page({ post, breadcrumb, tag, gallery }: BlogPostProps) {
  ...
  return <BlogArticle post={post} breadcrumb={breadcrumb} tag={tag}>
    <Paragraph>Taiwan si zažívá v posledních letech kulturní a společenské obrození. V každém městě, ve kterém jsme byli, jsme zaregistrovali novotou vonící knihovnu nebo divadlo, často obklopené parkem s hřišti.
      ...
      V parcích, na stanicích metra, ale i ve všech obchodních domech, knihovnách, muzeích, informačních centrech a přístavech jsou čisté záchody zdarma a jejich zaměstnanci nejsou povinováni návštěvníky nijak kontrolovat a zjišťovat zda tam "patří". Tam, kde není veřejná toaleta jako samostatná jednotka, poslouží ke stejnému účelu tzv. convinient store, malá sámoška (Seven eleven a Family Mart) otevřená 24 hodin denně, která má vždy dostupnou toaletu zdarma. Vykonání potřeby v důstojných a hygienických podmínkách je tady umožněno všem. V tomto ohledu je Taiwan solidární, a zároveň si chce zachovat svá veřejná místa hezká. Počítá přitom ale s pohybem lidí bez domova v místech, kterým umožňuje použití WC a umytí se. V mnoha evropských městech je velký nedostatek veřejných záchodů, které jsou často za poplatek, pokud vůbec. Řím je notoricky známý absencí veřejných toalet, a tak  člověk víc než nadšení z místa cítí pach moči a vidí občasný exkrement na těch nejžádanějších a tudíž nejvytíženějších turistických místech. Často si říkáme, jak Taiwanci na hygienický kulturní šok na předražené, vysněné dovolené do Evropy reagují.
      Máme někdy strach se zeptat, jak se v Praze líbilo. Vědomi si všech negativ - naštěstí, ale mnoho lidí ze všech koutů světa tvrdí, že Praha i nadále zůstává tím nejkrásnějším hlavním městem na světě.
    </Paragraph>

    <Gallery gallery={gallery1 || []} ></Gallery>

    <Paragraph>Na dětských hřištích, kam nás vozila maminka dětí, které jsme zde hlídali jsme kromě WC viděli i venkovní umyvadla a sprchy. Dalším krásným projektem jsou centra pro rodiny.
      Představte si prostor, který je asi tak troj až pětinásobně větší než běžná školka a je vybaven nejen bežnými hračkami, ale hrami, které pomáhají rozvíjet aspekty, které dítě v daném období rozvíjet potřebuje.
      ...
      Tato centra obsahují i dílny, kde si děti mohou něco vyrobit a taky čtecí koutek, kde mohou rodiče s dětmi zajít na besedu nebo pedagogickou konzultaci. Pak zde bývají i venkovní části, kde si děti mohou půjčit kolobežku nebo odrážedlo, to vše zdarma. Rodiče a opatrovníci tam s dětmi tedy můžou chodit každý den.
      Jako člověk, který má papír s názvem „osvědčení pro chůvy“ a taky jako kamarádka několika rodičů jsem k této oblasti pozorná a všimla jsem si častých „family toilets“ s malým záchodkem a přebalovacím pultem. Dále taky „Brestfeeding Room“, místnosti, kde může maminka v klidu nakojit v křesle nebo vysterilizovat lahvičku na mléko.
    </Paragraph>

    <Gallery gallery={gallery2 || []} ></Gallery>
    <Paragraph>Co se týče knihoven a muzeí, tak jsme byli ohromeni mírou investování do těchto institucí. Taiwanská vláda podporuje děti i dospělé ve čtení. Knihovny mají pohodlná křesílka různých typů, studovny a prosotory pro rodiny, koutky na hraní deskovek, kde se smí mluvit nahlas a často také kuchyňku.
    ...
    <Paragraph>Státní muzea, která jsme na Taiwanu zdarma navštívili se věnovala mladé historii Taiwanu, snaze informovat a upozorňovat na chyby i zločiny jeho nedemokratické minulosti a uctít památku všech perzekuovaných, většinou původních obyvatel Taiwanu.
      Bohužel ani současná taiwnská demokratická vláda se neobejde bez několika extremistů, jako jsou čínští nacionalisté, kteří mají rasistické názory na menšiny původních obyvatel.
      I přesto nebo právě v reakci na to, zde znova rozkvétá styl paiwanské tradiční hudby a hraní na paiwanskou nosní flétnu. Také hra na měsíční loutnu, tradičního nástroje pro velkou část Asie. V muzeu lidových písní ve městě Hengchun si lze objednat lekce na loutnu u místních babiček.
