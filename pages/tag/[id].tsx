...
function getTagDescription(tag: string): string {
  return `Explore blog posts tagged with "#${tag}" — curated stories, guides, and resources related to #${tag}.`;
}
...
export default function Tag({ tag }: Props) {
  return <div>
    <Article>
      ...
      <LeadingParagraph>{getTagDescription(tag.code)}</LeadingParagraph>
